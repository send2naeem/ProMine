...
// ..................................................................................................................................................
     ...
     * 'getSynsetDepth()') from a <root>
     * A synset may have multiple parents, thus we returneach possible depth and
     * 'home hierarchy' <root>
     * Thus, we may have the same <root> at different depths in the WordNet
     * hierarchy
     */
...
// test   
    ...
    public static double findSynsetDepth(String word, int senseNo)
    {
        Double _depth = 0D;
        ...
        try {
            ...
            Logger.getLogger(DepthFinder.class.getName()).log(Level.SEVERE, null, ex);
        }
        ICFinder icfinder = new ICFinder(icfile);
        DepthFinder depthfinder = new DepthFinder(dict, icfile);
        
        _depth = depthfinder.getSynsetDepth(word, senseNo, "n");
        return _depth;
    }
}
