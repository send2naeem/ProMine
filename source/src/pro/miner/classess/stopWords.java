...
try{
Scanner fip1=new Scanner(new File("checkingit.txt")); //file here from which you want to remove the stop words
FileOutputStream out=new FileOutputStream("removedstopwordsCheckingfile.txt");
String s1;
...
int flag=1;
s1=fip1.next();
System.out.println("This is text: " + s1);
s1=s1.toLowerCase();
System.out.println("This is LowerCase text: " + s1);
